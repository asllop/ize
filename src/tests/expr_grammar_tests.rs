...
use crate::{
    ast::{BinaryOp, Expression, Identifier, Literal, Primary, SelectUnwrapOp, UnaryOp},
    grammar_expr, lexer,
    parser::ParseNode,
    pos::{Pos, RangePos},
};
...
fn parse_single_expr(code: &str) -> ParseNode {
...
//TODO: check complex expression combination and precedence
